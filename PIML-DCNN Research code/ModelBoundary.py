...
class Model(nn.Module):
    ...
    def forward(self,Array,Input,back_up,epoch_now):
        ...
        if self.use_Unet == True:
            ...
            fc2 = self.fc2(fc1)
            fc3 = self.fc3(fc2)
            output1 = self.act(fc3)#*6.21#4.815
            ...
            #Best Boundary: 3-8
        return output, output2/output1,ratio,torch.mean(fc4_3d)/9 + 4/torch.mean(fc4_3d),torch.mean(output1)/6 + 3.17/torch.mean(output1)
